...
import { jsonToPhpArray } from '@/lib/converters'
  ...
  return (
    <>
      <ToolLayout
        ...
        description="Convert JSON to PHP array syntax instantly."
        inputPlaceholder="Paste your JSON here..."
        outputPlaceholder="PHP Arrays output will appear here..."
        convertLabel="Convert to PHP Arrays"
        onConvert={jsonToPhpArray}
      ...
      />
        ...
        <h2>How to Generate PHP Arrays</h2>
        <ol>
          ...
          <li><strong>Review Output</strong>: Your php arrays definitions appear instantly in the output panel.</li>
