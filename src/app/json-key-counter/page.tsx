...
export const metadata: Metadata = {
  title: 'JSON Key Counter Online — Free JSON Tool | JSONKits',
  description: 'Count key frequency and type breakdown across all objects. 100% client-side and free to use.',
