...
export const metadata: Metadata = {
  title: 'JSON Schema Validator Online — Free JSON Tool | JSONKits',
  description: 'Validate JSON data against a JSON Schema (draft-07). 100% client-side and free to use.',
