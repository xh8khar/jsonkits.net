...
import { jsonToC } from '@/lib/converters'

const example = JSON.stringify({ name: 'JSONKits', version: 1, features: ['json-to-c', 'validator', 'converter'], active: true, metadata: { author: 'Dev', created: '2024-01-01' } }, null, 2)
...
export default function ToolPageClient() {
  return (
    <>
      <ToolLayout
        title="JSON to C"
        description="Generate C struct definitions with JSON parsing support from JSON data samples."
