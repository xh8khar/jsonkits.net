...
import { jsonToHex, hexToJson } from '@/lib/converters'
...
export default function ToolPageClient() {
  return (
    <>
      <ToolLayout
        title="JSON to Hex Converter"
        description="Convert JSON data to hexadecimal string representation instantly."
      ...
      <article className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 prose prose-slate dark:prose-invert max-w-none">
          ...
          <table className="min-w-full border-collapse border border-slate-300 dark:border-slate-600 my-4">
            ...
            <tbody>
              <tr>
                ...
                <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">represents binary data as base-16 numbers using characters 0-9 and A-F</td>
              </tr>
              <tr>
        ...
        <h2>How to Convert JSON to Hexadecimal Online</h2>
        <ol>
          <li><strong>Paste JSON</strong>: Copy your JSON and paste it into the input editor.</li>
          <li><strong>Click Convert</strong>: Press the "Convert to Hex" button to transform your data.</li>
        ...
        <h2>Related Tools</h2>
        <ul>
          <li><a href="/hex">Reverse Converter</a> — Convert hexadecimal back to JSON</li>
