...
import { jsonToSwift } from '@/lib/converters'
...
export default function ToolPageClient() {
  return (
    <>
      <ToolLayout
        title="JSON to Swift Struct Generator"
        description="Generate Swift Codable structs from your JSON data instantly."
        inputPlaceholder="Paste your JSON here..."
        outputPlaceholder="Swift Structs output will appear here..."
        convertLabel="Generate Swift"
        onConvert={jsonToSwift}
      ...
      />
        ...
        <h2>How to Generate Swift Structs</h2>
        <ol>
          ...
          <li><strong>Review Output</strong>: Your swift structs definitions appear instantly in the output panel.</li>
