...
import { phpArrayToJson } from '@/lib/converters'
...
export default function ToolPageClient() {
  return (
    <>
      <ToolLayout
        title="PHP Array to JSON Converter"
        description="Convert PHP array syntax to JSON format instantly."
        inputPlaceholder="Paste your source code here..."
        outputPlaceholder="JSON output will appear here..."
        convertLabel="Convert to JSON"
        onConvert={phpArrayToJson}
      ...
      />
        ...
        <h2>PHP Arrays vs JSON: Understanding the Difference</h2>
        <p>PHP Arrays define the structure and types of data in code, while JSON provides a language-agnostic serialization format. Converting one to the other is essential for data interchange between services written in different languages.</p>
        ...
        <h2>How to Convert PHP Arrays to JSON Online</h2>
        <ol>
          <li><strong>Paste your code</strong>: Copy your php arrays definition from your editor.</li>
        ...
        <p>Converting php arrays to JSON is useful for generating API documentation from code, creating test fixtures from type definitions, producing sample data for frontend development, or debugging serialization issues by examining expected JSON shapes.</p>
        <h2>Related Tools</h2>
        <ul>
          <li><a href="/json-to-php-array">JSON to PHP Arrays</a> — Reverse direction: generate php arrays from JSON</li>
