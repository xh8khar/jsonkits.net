...
import { jsonToLua } from '@/lib/converters'
...
export default function ToolPageClient() {
  return (
    <>
      <ToolLayout
        title="JSON to Lua Table Converter"
        description="Convert JSON to Lua table syntax instantly."
        inputPlaceholder="Paste your JSON here..."
        outputPlaceholder="Lua Tables output will appear here..."
        convertLabel="Convert to Lua Tables"
        onConvert={jsonToLua}
      ...
      />
        ...
        <h2>How to Generate Lua Tables</h2>
        <ol>
          ...
          <li><strong>Review Output</strong>: Your lua tables definitions appear instantly in the output panel.</li>
