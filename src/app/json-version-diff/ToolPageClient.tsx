...
export default function ToolPageClient() {
  return (
    <>
      <ToolLayout
        title="JSON Version Diff"
        description="Compare two versions of JSON side by side. Perfect for developers working with JSON data."
        inputPlaceholder="Paste your JSON here..."
        outputPlaceholder="Result will appear here..."
        convertLabel="Diff"
        onConvert={jsonVersionDiff}
        exampleInput={example}
        outputLanguage={"json"}
      />
      <article className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 prose prose-slate dark:prose-invert">
        <h2>What Is This Tool?</h2>
        <p>Compare two versions of JSON side by side. This tool processes your JSON data entirely in your browser — nothing is uploaded to any server.</p>
        <h2>How to Use</h2>
        <ol>
          <li><strong>Paste your JSON</strong>: Enter or paste JSON data into the input editor.</li>
          <li><strong>Click Diff</strong>: Press the convert button to process your input.</li>
