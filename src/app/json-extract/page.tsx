...
export const metadata: Metadata = {
  title: 'JSON Extract Online — Free JSON Tool | JSONKits',
  description: 'Extract values from JSON using dot-notation path expressions. 100% client-side and free to use.',
