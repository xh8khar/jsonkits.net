...
const example = '{"database":{"host":"localhost","port":5432},"app":{"debug":true,"name":"JSONKits"}}'
  ...
  return (
    <>
      <ToolLayout
        ...
        description="Convert JSON data to INI configuration format instantly."
        inputPlaceholder="Paste your JSON here..."
        outputPlaceholder="INI output will appear here..."
      ...
      />
        ...
        <h2>How to Convert JSON to INI Online</h2>
        <ol>
          ...
          <li><strong>Click Convert</strong>: Press the "JSON to INI" button. The tool validates and transforms your data instantly.</li>
        ...
        <h3>Is this JSON to INI converter safe?</h3>
        ...
        <p>Converting JSON to INI is common in modern development workflows. Here are typical scenarios:</p>
