...
const example = 'app.name = JSONKits\napp.version = 1\napp.debug = true\napp.database.host = localhost\napp.database.port = 5432'
  ...
  return (
    <>
      <ToolLayout
        ...
        description="Convert Java .properties files to JSON format instantly."
        inputPlaceholder="Paste your .properties here..."
        outputPlaceholder="JSON output will appear here..."
        convertLabel="Convert to JSON"
        onConvert={propertiesToJson}
        exampleInput={example}
        inputLanguage="properties"
        outputLanguage="json"
        bidirectional
        onReverse={jsonToProperties}
      />
        ...
        <h2>How to Convert Java Properties to .properties Online</h2>
        <ol>
          <li><strong>Paste your Java Properties</strong>: Copy your Java Properties code from your editor or API response and paste it into the input box.</li>
          ...
          <li><strong>Click Convert</strong>: Press the "Java Properties to .properties" button. The tool validates and transforms your data instantly.</li>
        ...
        <h3>Is this Java Properties to .properties converter safe?</h3>
        ...
        <p>Converting Java Properties to .properties is common in modern development workflows. Here are typical scenarios:</p>
