...
export const metadata: Metadata = {
  title: 'JSON to Inline Online — Free JSON Tool | JSONKits',
  description: 'Convert JSON to a single-line or custom-indented inline format. 100% client-side and free to use.',
