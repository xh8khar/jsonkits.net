...
export const metadata: Metadata = {
  title: 'Mermaid to JSON Converter - Free Online Converter',
  ...
  alternates: { canonical: 'https://www.jsonkits.net/mermaid-to-json/' },
  openGraph: {
    title: 'Mermaid to JSON Converter - Free Online Converter',
    description: 'Parse Mermaid flowchart definitions into JSON format. 100% free, client-side JSON tool with no server uploads.',
    url: 'https://www.jsonkits.net/mermaid-to-json/',
    type: 'website',
  },
  twitter: {
