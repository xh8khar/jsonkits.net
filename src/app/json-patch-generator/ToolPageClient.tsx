...
import { jsonPatchGenerator } from '@/lib/converters'

const example = 'from:\n{"name":"Alice","age":30,"address":{"city":"NYC","zip":"10001"}}\nto:\n{"name":"Alice","age":31,"address":{"city":"LA","zip":"10001"}}'
  ...
  return (
    <>
      <ToolLayout
        ...
        description="Generate RFC 6902 JSON Patch operations. Perfect for developers working with JSON data."
        inputPlaceholder="Paste your JSON here..."
        outputPlaceholder="Result will appear here..."
        convertLabel="Generate"
        onConvert={jsonPatchGenerator}
        exampleInput={example}
        outputLanguage={"json"}
      />
      <article className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 prose prose-slate dark:prose-invert">
        <h2>What Is This Tool?</h2>
        <p>Generate RFC 6902 JSON Patch operations. This tool processes your JSON data entirely in your browser — nothing is uploaded to any server.</p>
        <h2>How to Use</h2>
        <ol>
