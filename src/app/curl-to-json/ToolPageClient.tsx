...
import { curlToJson, jsonToCurl } from '@/lib/converters'

const example = `curl -X POST \\
  -H "Content-Type: application/json" \\
  -d '{"name":"JSONKits","email":"dev@jsonkits.dev"}' \\
  ...
  return (
    <>
      ...
      <article className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 prose prose-slate dark:prose-invert max-w-none">
        ...
        <h2>How to Convert cURL Commands to JSON Online</h2>
        <ol>
          <li><strong>Paste Input</strong>: Copy your curl commands data and paste it into the input editor.</li>
        ...
        <p>Yes. The tool accurately parses curl commands input and converts it to valid JSON while preserving all data.</p>
        ...
        <h2>Related Tools</h2>
        <ul>
          <li><a href="/curl--to-json">Reverse Converter</a> — Convert curl commands back to JSON</li>
