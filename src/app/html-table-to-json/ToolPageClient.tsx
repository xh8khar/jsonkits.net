...
import { jsonToHtmlTable, htmlTableToJson } from '@/lib/converters'

const example = '<table>\n  <thead>\n    <tr><th>name</th><th>category</th><th>stars</th></tr>\n  </thead>\n  <tbody>\n    <tr><td>JSONKits</td><td>Converter</td><td>1500</td></tr>\n    <tr><td>ToolBox</td><td>Utility</td><td>850</td></tr>\n  </tbody>\n</table>'
  ...
  return (
    <>
      <ToolLayout
        ...
        description="Convert HTML tables to structured JSON format instantly."
        inputPlaceholder="Paste your HTML table here..."
        outputPlaceholder="JSON output will appear here..."
        convertLabel="Convert to JSON"
        onConvert={htmlTableToJson}
        exampleInput={example}
        inputLanguage="html"
        outputLanguage="json"
        bidirectional
        onReverse={jsonToHtmlTable}
      />
          ...
          <table className="min-w-full border-collapse border border-slate-300 dark:border-slate-600 my-4">
            <thead>
              <tr className="bg-slate-100 dark:bg-slate-800">
                ...
                <th className="border border-slate-300 dark:border-slate-600 px-4 py-2 text-left font-semibold">HTML Tables</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                ...
                <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">Good when rendered, verbose in source.</td>
              </tr>
              <tr>
                ...
                <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">Supported using {'<!-- -->'}.</td>
              </tr>
              <tr>
                ...
                <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">Fast in browser rendering.</td>
              </tr>
              <tr>
                ...
                <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">All types stored as text in cells.</td>
              </tr>
              <tr>
                ...
                <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">Web page data display.</td>
              </tr>
            </tbody>
          </table>
        </div>
        <h2>How to Convert HTML Tables to HTML Tables Online</h2>
        <ol>
          <li><strong>Paste your HTML Tables</strong>: Copy your HTML Tables code from your editor or API response and paste it into the input box.</li>
        ...
        <p>Converting HTML Tables to HTML Tables is common in modern development workflows. Here are typical scenarios:</p>
        ...
        <h2>Related Tools</h2>
        <ul>
          <li><a href="/html-table-to-json">HTML Tables to JSON</a> — Reverse conversion from HTML Tables back to JSON</li>
