...
export const metadata: Metadata = {
  title: 'JSON Depth Analyzer Online — Free JSON Tool | JSONKits',
  description: 'Analyze nesting depth, node count, and branching of JSON. 100% client-side and free to use.',
