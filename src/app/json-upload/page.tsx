...
export const metadata: Metadata = {
  title: 'JSON Upload Online — Free JSON Tool | JSONKits',
  description: 'Upload a .json file and view or process its contents instantly. 100% client-side and free to use.',
