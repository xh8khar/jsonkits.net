...
import { jsonToMatlab } from '@/lib/converters'
...
export default function ToolPageClient() {
  return (
    <>
      <ToolLayout
        title="JSON to MATLAB Struct Converter"
        description="Convert JSON to MATLAB struct syntax instantly."
        inputPlaceholder="Paste your JSON here..."
        outputPlaceholder="MATLAB Structs output will appear here..."
        convertLabel="Generate MATLAB Structs"
        onConvert={jsonToMatlab}
        exampleInput={example}
        inputLanguage="json"
        outputLanguage="matlab"
      />
        ...
        <h2>How to Generate MATLAB Structs</h2>
        <ol>
          ...
          <li><strong>Review Output</strong>: Your matlab structs definitions appear instantly in the output panel.</li>
