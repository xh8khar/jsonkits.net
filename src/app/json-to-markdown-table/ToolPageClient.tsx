  ...
  return (
    <>
      <ToolLayout
        ...
        description="Convert JSON data to a Markdown table instantly."
        inputPlaceholder="Paste your JSON here..."
        outputPlaceholder="Markdown table output will appear here..."
        convertLabel="Convert to Markdown"
        onConvert={jsonToMarkdownTable}
        exampleInput={example}
        inputLanguage="json"
        outputLanguage="markdown"
        bidirectional
        onReverse={markdownTableToJson}
      />
        ...
        <h2>How to Convert JSON to Markdown Tables Online</h2>
        <ol>
          ...
          <li><strong>Click Convert</strong>: Press the "JSON to Markdown Tables" button. The tool validates and transforms your data instantly.</li>
        ...
        <h3>Is this JSON to Markdown Tables converter safe?</h3>
        ...
        <p>Converting JSON to Markdown Tables is common in modern development workflows. Here are typical scenarios:</p>
