...
import { jsonToR } from '@/lib/converters'
...
export default function ToolPageClient() {
  return (
    <>
      <ToolLayout
        title="JSON to R List Converter"
        description="Convert JSON to R list syntax instantly."
        inputPlaceholder="Paste your JSON here..."
        outputPlaceholder="R Lists output will appear here..."
        convertLabel="Convert to R Lists"
        onConvert={jsonToR}
      ...
      />
        ...
        <ol>
          ...
          <li><strong>Review Output</strong>: Your r lists definitions appear instantly in the output panel.</li>
