...
const example = 'name\tversion\tactive\nJSONKits\t1\ttrue\nToolBox\t2\tfalse'
  ...
  return (
    <>
      <ToolLayout
        ...
        description="Convert tab-separated values to structured JSON format instantly."
        inputPlaceholder="Paste your TSV here..."
      ...
      />
        ...
        <h2>How to Convert TSV to TSV Online</h2>
        <ol>
          <li><strong>Paste your TSV</strong>: Copy your TSV code from your editor or API response and paste it into the input box.</li>
          ...
          <li><strong>Click Convert</strong>: Press the "TSV to TSV" button. The tool validates and transforms your data instantly.</li>
        ...
        <h3>Is this TSV to TSV converter safe?</h3>
        ...
        <p>Converting TSV to TSV is common in modern development workflows. Here are typical scenarios:</p>
