...
export const metadata: Metadata = {
  title: 'JSON to Form Data Converter - Free Online Converter',
  ...
  alternates: { canonical: 'https://www.jsonkits.net/json-to-form-data/' },
  openGraph: {
    title: 'JSON to Form Data Converter - Free Online Converter',
    description: 'Convert JSON objects to URL-encoded form data. 100% free, client-side JSON tool with no server uploads.',
    url: 'https://www.jsonkits.net/json-to-form-data/',
    type: 'website',
  },
  twitter: {
