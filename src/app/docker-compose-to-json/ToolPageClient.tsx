...
import { dockerComposeToJson, jsonToDockerCompose } from '@/lib/converters'
...
export default function ToolPageClient() {
  return (
    <>
      <ToolLayout
        title="Docker Compose to JSON Converter"
        description="Convert Docker Compose YAML files back to JSON format instantly."
        inputPlaceholder="Paste your input here..."
        outputPlaceholder="Converted output will appear here..."
        convertLabel="Convert to JSON"
        onConvert={dockerComposeToJson}
        exampleInput={example}
        inputLanguage="yaml"
        outputLanguage="json"
        bidirectional
        onReverse={jsonToDockerCompose}
      />
      <article className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 prose prose-slate dark:prose-invert max-w-none">
        ...
        <h2>Related Tools</h2>
        <ul>
          <li><a href="/docker-compose--to-json">Reverse Converter</a> — Convert yaml back to JSON</li>
