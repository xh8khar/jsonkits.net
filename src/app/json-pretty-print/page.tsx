...
export const metadata: Metadata = {
  title: 'JSON Pretty Print Online — Free JSON Tool | JSONKits',
  description: 'Pretty-print JSON data with customizable indentation. 100% client-side and free to use.',
