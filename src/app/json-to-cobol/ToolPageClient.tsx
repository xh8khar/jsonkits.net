...
import { jsonToCobol } from '@/lib/converters'

const example = JSON.stringify({ name: 'JSONKits', version: 1, features: ['json-to-cobol', 'validator', 'converter'], active: true }, null, 2)
  ...
  return (
    <>
      <ToolLayout
        ...
        outputPlaceholder="JSON to COBOL output will appear here..."
        convertLabel="Convert"
        onConvert={jsonToCobol}
        exampleInput={example}
        inputLanguage="json"
        outputLanguage="cobol"
      />
      <article className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 prose prose-slate dark:prose-invert max-w-none">
        <h2>What Is COBOL?</h2>
        <p>JSON to COBOL is a free online tool that converts JSON data into cobol format for use in various programming environments. This tool is 100% client-side and processes all data locally in your browser.</p>
        <h2>How to Use</h2>
        <ol>
