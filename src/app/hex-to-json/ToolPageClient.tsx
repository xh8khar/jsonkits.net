...
import { hexToJson, jsonToHex } from '@/lib/converters'

const example = `7b226e616d65223a224a534f4e4b697473222c2276657273696f6e223a317d`

export default function ToolPageClient() {
  return (
    <>
      <ToolLayout
        title="Hex to JSON Converter"
        description="Convert hexadecimal strings back to JSON format instantly."
      ...
      <article className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 prose prose-slate dark:prose-invert">
        ...
        <ul>
          <li><strong>Cryptography</strong>: Representing hash values and encryption keys.</li>
          <li><strong>Color Codes</strong>: Web colors like #FF5733.</li>
          <li><strong>Memory Dumps</strong>: Debugging binary data in human-readable form.</li>
        </ul>
        <h2>What Is JSON?</h2>
          ...
          <table className="min-w-full border-collapse border border-slate-300 dark:border-slate-600 my-4">
            <thead>
              <tr className="bg-slate-100 dark:bg-slate-800">
                ...
                <th className="border border-slate-300 dark:border-slate-600 px-4 py-2 text-left font-semibold">Hexadecimal</th>
              </tr>
            </thead>
            <tbody>
              <tr>
        ...
        <h2>How to Convert Hexadecimal to JSON Online</h2>
        <ol>
          <li><strong>Paste Input</strong>: Copy your hexadecimal data and paste it into the input editor.</li>
        ...
        <p>Yes. The tool accurately parses hexadecimal input and converts it to valid JSON while preserving all data.</p>
        ...
        <p>Converting between JSON and hexadecimal is a common task in modern development workflows. Developers use this conversion for data transformation, format migration, and interoperability between different systems and tools.</p>
        <h2>Related Tools</h2>
        <ul>
          <li><a href="/hex--to-json">Reverse Converter</a> — Convert hexadecimal back to JSON</li>
