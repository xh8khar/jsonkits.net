  ...
  return (
    <>
      <ToolLayout
        ...
        description="Convert JSON data to TOML format instantly. Perfect for Rust and Python project configurations."
        inputPlaceholder="Paste your JSON here..."
        outputPlaceholder="TOML output will appear here..."
        convertLabel="Convert to TOML"
        onConvert={jsonToToml}
        exampleInput={example}
        inputLanguage="json"
        outputLanguage="toml"
        bidirectional
        onReverse={tomlToJson}
      />
        ...
        <h2>How to Convert JSON to TOML Online</h2>
        <ol>
          ...
          <li><strong>Click Convert</strong>: Press the "JSON to TOML" button. The tool validates and transforms your data instantly.</li>
        ...
        <h3>Is this JSON to TOML converter safe?</h3>
        ...
        <p>Converting JSON to TOML is common in modern development workflows. Here are typical scenarios:</p>
