...
import { jsonToEnv, envToJson } from '@/lib/converters'

const example = `{"appName":"JSONKits","appVersion":1,"debug":true}`
  ...
  return (
    <>
      <ToolLayout
        ...
        description="Convert JSON objects to .env file format for environment variables instantly."
        inputPlaceholder="Paste your input here..."
        outputPlaceholder="Converted output will appear here..."
        convertLabel="Convert to .env"
        onConvert={jsonToEnv}
      ...
      <article className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 prose prose-slate dark:prose-invert max-w-none">
        ...
        <ul>
          <li><strong>Development</strong>: Local environment variables with dotenv.</li>
          <li><strong>Docker</strong>: Passing configuration to containers.</li>
          <li><strong>CI/CD Pipelines</strong>: Managing build and deployment settings.</li>
        </ul>
          ...
          <table className="min-w-full border-collapse border border-slate-300 dark:border-slate-600 my-4">
            <thead>
              <tr className="bg-slate-100 dark:bg-slate-800">
                ...
                <th className="border border-slate-300 dark:border-slate-600 px-4 py-2 text-left font-semibold">.env</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                ...
                <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">store configuration key-value pairs for applications</td>
              </tr>
              <tr>
        ...
        <ol>
          ...
          <li><strong>Click Convert</strong>: Press the "Convert to .env" button to transform your data.</li>
        ...
        <p>Converting between JSON and .env is a common task in modern development workflows. Developers use this conversion for data transformation, format migration, and interoperability between different systems and tools.</p>
        <h2>Related Tools</h2>
        <ul>
          <li><a href="/env">Reverse Converter</a> — Convert .env back to JSON</li>
