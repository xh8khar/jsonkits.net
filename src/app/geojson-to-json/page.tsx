...
export const metadata: Metadata = {
  title: 'GeoJSON to JSON Converter - Free Online Converter',
  ...
  alternates: { canonical: 'https://www.jsonkits.net/geojson-to-json/' },
  openGraph: {
    title: 'GeoJSON to JSON Converter - Free Online Converter',
    description: 'Extract properties from GeoJSON features to standard JSON. 100% free, client-side JSON tool with no server uploads.',
    url: 'https://www.jsonkits.net/geojson-to-json/',
    type: 'website',
  },
  twitter: {
