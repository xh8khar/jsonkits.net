...
import { jsonToSqlCreate } from '@/lib/converters'

const example = JSON.stringify({ name: 'JSONKits', version: 1, features: ['json-to-sql-create', 'validator', 'converter'], active: true, metadata: { author: 'Dev', created: '2024-01-01' } }, null, 2)

export default function ToolPageClient() {
  return (
    <>
      <ToolLayout
        title="JSON to SQL CREATE TABLE"
        description="Generate SQL CREATE TABLE statements from JSON data samples for PostgreSQL, MySQL, SQLite, SQL Server, and Oracle."
        inputPlaceholder="Paste your JSON here..."
        outputPlaceholder="Output will appear here..."
        convertLabel="JSON to SQL CREATE TABLE"
        onConvert={jsonToSqlCreate}
