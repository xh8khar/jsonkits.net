...
import { jwtEncode } from '@/lib/converters'

const example = JSON.stringify({ name: 'JSONKits', version: 1, features: ['jwt-encoder', 'validator', 'converter'], active: true, metadata: { author: 'Dev', created: '2024-01-01' } }, null, 2)
...
export default function ToolPageClient() {
  return (
    <>
      <ToolLayout
        title="JWT Encoder"
        description="Create JSON Web Tokens (JWT) by encoding header and payload with HS256 or HS512 signing algorithms."
