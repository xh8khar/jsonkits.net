...
export const metadata: Metadata = {
  title: 'JSON Extract Objects Online — Free JSON Tool | JSONKits',
  description: 'Extract all object nodes from JSON data into a flat list. 100% client-side and free to use.',
