...
import { typescriptInterfaceToJson } from '@/lib/converters'
...
export default function ToolPageClient() {
  return (
    <>
      <ToolLayout
        title="TypeScript Interface to JSON Generator"
        description="Generate sample JSON data from TypeScript interface definitions instantly."
        inputPlaceholder="Paste your source code here..."
        outputPlaceholder="JSON output will appear here..."
        convertLabel="Convert to JSON"
        onConvert={typescriptInterfaceToJson}
      ...
      />
        ...
        <h2>TypeScript Interfaces vs JSON: Understanding the Difference</h2>
        <p>TypeScript Interfaces define the structure and types of data in code, while JSON provides a language-agnostic serialization format. Converting one to the other is essential for data interchange between services written in different languages.</p>
        ...
        <h2>How to Convert TypeScript Interfaces to JSON Online</h2>
        <ol>
          <li><strong>Paste your code</strong>: Copy your typescript interfaces definition from your editor.</li>
        ...
        <p>Converting typescript interfaces to JSON is useful for generating API documentation from code, creating test fixtures from type definitions, producing sample data for frontend development, or debugging serialization issues by examining expected JSON shapes.</p>
        <h2>Related Tools</h2>
        <ul>
          <li><a href="/json-to-typescript">JSON to TypeScript Interfaces</a> — Reverse direction: generate typescript interfaces from JSON</li>
