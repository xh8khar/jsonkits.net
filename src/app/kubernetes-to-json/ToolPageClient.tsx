...
import { kubernetesToJson, jsonToKubernetes } from '@/lib/converters'
...
export default function ToolPageClient() {
  return (
    <>
      <ToolLayout
        title="Kubernetes YAML to JSON Converter"
        description="Convert Kubernetes manifest YAML files back to JSON format instantly."
        inputPlaceholder="Paste your input here..."
        outputPlaceholder="Converted output will appear here..."
        convertLabel="Convert to JSON"
        onConvert={kubernetesToJson}
        exampleInput={example}
        inputLanguage="yaml"
        outputLanguage="json"
        bidirectional
        onReverse={jsonToKubernetes}
      />
      <article className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 prose prose-slate dark:prose-invert">
        ...
        <h2>Related Tools</h2>
        <ul>
          <li><a href="/kubernetes--to-json">Reverse Converter</a> — Convert yaml back to JSON</li>
