...
import { jsonToIni, iniToJson } from '@/lib/converters'
  ...
  return (
    <>
      <ToolLayout
        ...
        description="Convert INI configuration files to JSON format instantly."
        inputPlaceholder="Paste your INI here..."
      ...
      />
          ...
          <table className="min-w-full border-collapse border border-slate-300 dark:border-slate-600 my-4">
            <thead>
              <tr className="bg-slate-100 dark:bg-slate-800">
                ...
                <th className="border border-slate-300 dark:border-slate-600 px-4 py-2 text-left font-semibold">INI</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                ...
                <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">Good. Simple section and key=value format.</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">Fast due to simple parsing rules.</td>
              </tr>
              <tr>
                ...
                <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">Strings and numbers only.</td>
              </tr>
              <tr>
                ...
                <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">Legacy and system configuration files.</td>
              </tr>
            </tbody>
          </table>
        </div>
        <h2>How to Convert INI to INI Online</h2>
        <ol>
          <li><strong>Paste your INI</strong>: Copy your INI code from your editor or API response and paste it into the input box.</li>
        ...
        <p>Converting INI to INI is common in modern development workflows. Here are typical scenarios:</p>
        ...
        <h2>Related Tools</h2>
        <ul>
          <li><a href="/ini-to-json">INI to JSON</a> — Reverse conversion from INI back to JSON</li>
