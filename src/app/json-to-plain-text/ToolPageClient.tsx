...
const example = '{"user":{"name":"Alice","age":30,"active":true},"roles":["admin","editor"]}'

export default function ToolPageClient() {
  return (
    <>
      <ToolLayout
        title="JSON to Plain Text Converter"
        description="Flatten JSON objects into plain key: value text instantly."
        inputPlaceholder="Paste your JSON here..."
        outputPlaceholder="Plain text output will appear here..."
        convertLabel="Convert to Text"
        onConvert={jsonToPlainText}
        exampleInput={example}
        inputLanguage="json"
        outputLanguage="text"
        bidirectional
        onReverse={plainTextToJson}
      />
        ...
        <h2>How to Convert JSON to Plain Text Online</h2>
        <ol>
          ...
          <li><strong>Click Convert</strong>: Press the "JSON to Plain Text" button. The tool validates and transforms your data instantly.</li>
        ...
        <h3>Is this JSON to Plain Text converter safe?</h3>
        ...
        <p>Converting JSON to Plain Text is common in modern development workflows. Here are typical scenarios:</p>
