...
import { jsonToKotlin } from '@/lib/converters'
  ...
  return (
    <>
      <ToolLayout
        ...
        description="Generate Kotlin data classes from your JSON data instantly."
        inputPlaceholder="Paste your JSON here..."
        outputPlaceholder="Kotlin Data Classes output will appear here..."
        convertLabel="Generate Kotlin"
        onConvert={jsonToKotlin}
      ...
      />
        ...
        <h2>How to Generate Kotlin Data Classes</h2>
        <ol>
          ...
          <li><strong>Review Output</strong>: Your kotlin data classes definitions appear instantly in the output panel.</li>
