  ...
  return (
    <>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-fade-in">
        ...
        <p className="text-slate-600 dark:text-slate-400 max-w-3xl mb-8">Fetch and display JSON data from any REST API endpoint. Enter a URL and click Fetch to see the formatted response.</p>
