...
export const metadata: Metadata = {
  title: 'JSON URL Viewer Online — Free JSON Tool | JSONKits',
  description: 'Fetch and display JSON data from a remote URL endpoint. 100% client-side and free to use.',
