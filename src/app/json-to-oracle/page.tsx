...
export const metadata: Metadata = {
  title: 'JSON to Oracle Converter - Free Online Converter',
  ...
  alternates: { canonical: 'https://www.jsonkits.net/json-to-oracle/' },
  openGraph: {
    title: 'JSON to Oracle Converter - Free Online Converter',
    description: 'Generate Oracle SQL CREATE TABLE and INSERT statements from JSON. 100% free, client-side JSON tool with no server uploads.',
    url: 'https://www.jsonkits.net/json-to-oracle/',
    type: 'website',
  },
  twitter: {
