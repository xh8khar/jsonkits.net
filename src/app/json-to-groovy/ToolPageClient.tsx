...
import { jsonToGroovy } from '@/lib/converters'

const example = JSON.stringify({ name: 'JSONKits', version: 1, features: ['json-to-groovy', 'validator', 'converter'], active: true, metadata: { author: 'Dev', created: '2024-01-01' } }, null, 2)

export default function ToolPageClient() {
  return (
    <>
      <ToolLayout
        title="JSON to Groovy"
        description="Generate Groovy class definitions with JSON parsing support from JSON data samples."
        inputPlaceholder="Paste your JSON here..."
        outputPlaceholder="Output will appear here..."
        convertLabel="JSON to Groovy"
        onConvert={jsonToGroovy}
      ...
      <article className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 prose prose-slate dark:prose-invert max-w-none">
        ...
        <ul>
          ...
          <li><a href="/json-to-elixir">JSON to Elixir</a> — Generate Elixir struct definitions with JSON encoding support from JSON data samples.</li>
        </ul>
      </article>
    </>
  )
