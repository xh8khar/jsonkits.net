...
import { csvToJson, jsonToCsv } from '@/lib/converters'

const example = 'name,role,active\nAlice,Engineer,true\nBob,Designer,false'
  ...
  return (
    <>
      <ToolLayout
        ...
        description="Convert CSV data to JSON format for APIs, data processing, and web development. Handles headers, data types, and empty lines automatically."
      ...
      />
        ...
        <h2>How to Convert CSV to CSV Online</h2>
        <ol>
          <li><strong>Paste your CSV</strong>: Copy your CSV code from your editor or API response and paste it into the input box.</li>
          ...
          <li><strong>Click Convert</strong>: Press the "CSV to CSV" button. The tool validates and transforms your data instantly.</li>
        ...
        <h3>Is this CSV to CSV converter safe?</h3>
        ...
        <p>Converting CSV to CSV is common in modern development workflows. Here are typical scenarios:</p>
