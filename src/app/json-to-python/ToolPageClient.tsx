  ...
  return (
    <>
      <ToolLayout
        ...
        description="Generate Python dataclasses from your JSON data instantly. Perfect for typing API responses and configuration objects in Python projects."
      ...
      />
        ...
        <h2>How to Generate Python Dataclasses</h2>
        <ol>
          ...
          <li><strong>Review Output</strong>: Your python dataclasses definitions appear instantly in the output panel.</li>
