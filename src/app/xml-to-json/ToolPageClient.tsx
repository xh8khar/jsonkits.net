...
import { xmlToJson, jsonToXml } from '@/lib/converters'
  ...
  return (
    <>
      <ToolLayout
        ...
        description="Convert XML documents to JSON format instantly. Perfect for modernizing legacy APIs and feeding XML data into JavaScript applications."
      ...
      />
          ...
          <table className="min-w-full border-collapse border border-slate-300 dark:border-slate-600 my-4">
            <thead>
              <tr className="bg-slate-100 dark:bg-slate-800">
                ...
                <th className="border border-slate-300 dark:border-slate-600 px-4 py-2 text-left font-semibold">XML</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                ...
                <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">Moderate. Verbose with opening/closing tags.</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">Slower due to complex parsing.</td>
              </tr>
              <tr>
                ...
                <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">Rich type system with schemas (XSD).</td>
              </tr>
              <tr>
                ...
                <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">Enterprise SOAP APIs and document storage.</td>
              </tr>
            </tbody>
          </table>
        </div>
        <h2>How to Convert XML to XML Online</h2>
        <ol>
          <li><strong>Paste your XML</strong>: Copy your XML code from your editor or API response and paste it into the input box.</li>
        ...
        <p>Converting XML to XML is common in modern development workflows. Here are typical scenarios:</p>
        ...
        <h2>Related Tools</h2>
        <ul>
          <li><a href="/xml-to-json">XML to JSON</a> — Reverse conversion from XML back to JSON</li>
