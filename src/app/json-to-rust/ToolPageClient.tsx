...
import { jsonToRust } from '@/lib/converters'
  ...
  return (
    <>
      <ToolLayout
        ...
        description="Generate Rust structs with Serde attributes from your JSON data instantly."
        inputPlaceholder="Paste your JSON here..."
        outputPlaceholder="Rust Structs output will appear here..."
        convertLabel="Generate Rust"
        onConvert={jsonToRust}
      ...
      />
        ...
        <h2>How to Generate Rust Structs</h2>
        <ol>
          ...
          <li><strong>Review Output</strong>: Your rust structs definitions appear instantly in the output panel.</li>
