...
import { jsonToPerl } from '@/lib/converters'
...
export default function ToolPageClient() {
  return (
    <>
      <ToolLayout
        title="JSON to Perl Data Structure Converter"
        description="Convert JSON to Perl data structure syntax instantly."
        inputPlaceholder="Paste your JSON here..."
        outputPlaceholder="Perl Data Structures output will appear here..."
        convertLabel="Generate Perl Data Structures"
        onConvert={jsonToPerl}
      ...
      />
        ...
        <h2>How to Generate Perl Data Structures</h2>
        <ol>
          ...
          <li><strong>Review Output</strong>: Your perl data structures definitions appear instantly in the output panel.</li>
