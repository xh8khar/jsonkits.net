...
import { jsonToMongoAgg } from '@/lib/converters'

const example = JSON.stringify({ name: 'JSONKits', version: 1, features: ['json-to-mongodb-aggregation', 'validator', 'converter'], active: true, metadata: { author: 'Dev', created: '2024-01-01' } }, null, 2)

export default function ToolPageClient() {
  return (
    <>
      <ToolLayout
        title="JSON to MongoDB Aggregation"
        description="Generate MongoDB aggregation pipeline stages from JSON data queries for advanced database operations."
        inputPlaceholder="Paste your JSON here..."
        outputPlaceholder="Output will appear here..."
        convertLabel="JSON to MongoDB Aggregation"
        onConvert={jsonToMongoAgg}
