...
export const metadata: Metadata = {
  title: 'Extract Nested Objects Online — Free JSON Tool | JSONKits',
  description: 'Extract all nested objects from JSON into a flat list. 100% client-side and free to use.',
