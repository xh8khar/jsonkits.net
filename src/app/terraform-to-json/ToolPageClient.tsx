...
import { terraformToJson, jsonToTerraform } from '@/lib/converters'

const example = `region: "us-east-1"\ninstanceType: "t2.micro"\ncount: 3`

export default function ToolPageClient() {
  return (
    <>
      <ToolLayout
        title="Terraform Variables to JSON Converter"
        description="Convert Terraform variables files back to JSON format instantly."
        inputPlaceholder="Paste your input here..."
        outputPlaceholder="Converted output will appear here..."
        convertLabel="Convert to JSON"
        onConvert={terraformToJson}
        exampleInput={example}
        inputLanguage="yaml"
        outputLanguage="json"
        bidirectional
        onReverse={jsonToTerraform}
      />
      <article className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 prose prose-slate dark:prose-invert">
        ...
        <ol>
          <li><strong>Paste Input</strong>: Copy your yaml data and paste it into the input editor.</li>
        ...
        <p>Yes. The tool accurately parses yaml input and converts it to valid JSON while preserving all data.</p>
        ...
        <h2>Related Tools</h2>
        <ul>
          <li><a href="/terraform--to-json">Reverse Converter</a> — Convert yaml back to JSON</li>
