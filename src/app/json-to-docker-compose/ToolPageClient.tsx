...
import { jsonToDockerCompose, dockerComposeToJson } from '@/lib/converters'

const example = `{"version":"3","services":{"web":{"image":"nginx","ports":["80:80"]}}}`

export default function ToolPageClient() {
  return (
    <>
      <ToolLayout
        title="JSON to Docker Compose Converter"
        description="Convert JSON data to Docker Compose YAML format instantly."
        inputPlaceholder="Paste your input here..."
        outputPlaceholder="Converted output will appear here..."
        convertLabel="Convert to Compose"
        onConvert={jsonToDockerCompose}
        exampleInput={example}
        inputLanguage="json"
        outputLanguage="yaml"
        bidirectional
        onReverse={dockerComposeToJson}
      />
      <article className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 prose prose-slate dark:prose-invert">
        ...
        <ol>
          ...
          <li><strong>Click Convert</strong>: Press the "Convert to Compose" button to transform your data.</li>
        ...
        <h2>Related Tools</h2>
        <ul>
          <li><a href="/docker-compose">Reverse Converter</a> — Convert yaml back to JSON</li>
