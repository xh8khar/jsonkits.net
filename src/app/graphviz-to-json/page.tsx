...
export const metadata: Metadata = {
  title: 'Graphviz to JSON Converter - Free Online Converter',
  ...
  alternates: { canonical: 'https://www.jsonkits.net/graphviz-to-json/' },
  openGraph: {
    title: 'Graphviz to JSON Converter - Free Online Converter',
    description: 'Parse Graphviz DOT format back into JSON structure. 100% free, client-side JSON tool with no server uploads.',
    url: 'https://www.jsonkits.net/graphviz-to-json/',
    type: 'website',
  },
  twitter: {
