...
import { jsonToRuby } from '@/lib/converters'
...
export default function ToolPageClient() {
  return (
    <>
      <ToolLayout
        title="JSON to Ruby Hash Converter"
        description="Convert JSON to Ruby hash syntax instantly."
        inputPlaceholder="Paste your JSON here..."
        outputPlaceholder="Ruby Hashes output will appear here..."
        convertLabel="Convert to Ruby Hashes"
        onConvert={jsonToRuby}
      ...
      />
        ...
        <h2>How to Generate Ruby Hashes</h2>
        <ol>
          ...
          <li><strong>Review Output</strong>: Your ruby hashes definitions appear instantly in the output panel.</li>
