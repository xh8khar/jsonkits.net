...
import { jsonToSas } from '@/lib/converters'

const example = JSON.stringify({ name: 'JSONKits', version: 1, features: ['json-to-sas', 'validator', 'converter'], active: true }, null, 2)
  ...
  return (
    <>
      <ToolLayout
        ...
        outputPlaceholder="JSON to SAS output will appear here..."
