...
import { base64ToJson, jsonToBase64 } from '@/lib/converters'

const example = `eyJuYW1lIjoiSlNPTktpdHMiLCJ2ZXJzaW9uIjoxfQ==`
  ...
  return (
    <>
      ...
      <article className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 prose prose-slate dark:prose-invert max-w-none">
        ...
        <h2>How to Convert Base64 to JSON Online</h2>
        <ol>
          <li><strong>Paste Input</strong>: Copy your base64 data and paste it into the input editor.</li>
        ...
        <p>Yes. The tool accurately parses base64 input and converts it to valid JSON while preserving all data.</p>
        ...
        <h2>Related Tools</h2>
        <ul>
          <li><a href="/base64--to-json">Reverse Converter</a> — Convert base64 back to JSON</li>
