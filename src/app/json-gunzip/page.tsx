...
export const metadata: Metadata = {
  title: 'JSON Gunzip Online — Free JSON Tool | JSONKits',
  description: 'Decompress Gzip-compressed JSON from Base64 back to readable text. 100% client-side and free to use.',
