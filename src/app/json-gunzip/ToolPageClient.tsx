...
export default function ToolPageClient() {
  return (
    <>
      <ToolLayout
        title="JSON Gunzip"
        description="Decompress Gzip-compressed JSON from Base64. Perfect for developers working with JSON data."
        inputPlaceholder="Paste your JSON here..."
        outputPlaceholder="Result will appear here..."
        convertLabel="Gunzip"
        onConvert={jsonGunzip}
        exampleInput={example}
        outputLanguage={"text"}
      />
      <article className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 prose prose-slate dark:prose-invert">
        <h2>What Is This Tool?</h2>
        <p>Decompress Gzip-compressed JSON from Base64. This tool processes your JSON data entirely in your browser — nothing is uploaded to any server.</p>
        <h2>How to Use</h2>
        <ol>
          <li><strong>Paste your JSON</strong>: Enter or paste JSON data into the input editor.</li>
          <li><strong>Click Gunzip</strong>: Press the convert button to process your input.</li>
