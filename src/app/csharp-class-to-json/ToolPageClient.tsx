...
import { csharpClassToJson } from '@/lib/converters'
...
export default function ToolPageClient() {
  return (
    <>
      <ToolLayout
        title="C# Class to JSON Generator"
        description="Generate sample JSON data from C# class definitions instantly."
        inputPlaceholder="Paste your source code here..."
        outputPlaceholder="JSON output will appear here..."
        convertLabel="Convert to JSON"
        onConvert={csharpClassToJson}
      ...
      />
        ...
        <h2>C# Classes vs JSON: Understanding the Difference</h2>
        <p>C# Classes define the structure and types of data in code, while JSON provides a language-agnostic serialization format. Converting one to the other is essential for data interchange between services written in different languages.</p>
        ...
        <h2>How to Convert C# Classes to JSON Online</h2>
        <ol>
          <li><strong>Paste your code</strong>: Copy your c# classes definition from your editor.</li>
        ...
        <p>Converting c# classes to JSON is useful for generating API documentation from code, creating test fixtures from type definitions, producing sample data for frontend development, or debugging serialization issues by examining expected JSON shapes.</p>
        <h2>Related Tools</h2>
        <ul>
          <li><a href="/json-to-csharp">JSON to C# Classes</a> — Reverse direction: generate c# classes from JSON</li>
