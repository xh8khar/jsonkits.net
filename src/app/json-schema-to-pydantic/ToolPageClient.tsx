...
import { jsonSchemaToPydantic } from '@/lib/converters'

const example = JSON.stringify({ name: 'JSONKits', version: 1, features: ['json-schema-to-pydantic', 'validator', 'converter'], active: true, metadata: { author: 'Dev', created: '2024-01-01' } }, null, 2)
  ...
  return (
    <>
      <ToolLayout
        ...
        description="Generate Python Pydantic model classes with validation rules from JSON Schema (draft-07) definitions."
        inputPlaceholder="Paste your JSON here..."
        outputPlaceholder="Output will appear here..."
        convertLabel="Convert"
        onConvert={jsonSchemaToPydantic}
