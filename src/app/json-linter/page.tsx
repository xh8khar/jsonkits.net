...
export const metadata: Metadata = {
  title: 'JSON Linter Online — Free JSON Tool | JSONKits',
  description: 'Lint JSON for style issues, duplicate keys, and naming conventions. 100% client-side and free to use.',
