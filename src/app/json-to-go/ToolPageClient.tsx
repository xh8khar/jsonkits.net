...
import { jsonToGo } from '@/lib/converters'
  ...
  return (
    <>
      <ToolLayout
        ...
        description="Generate Go structs with JSON tags from your JSON data instantly. Perfect for unmarshaling API responses in Go projects."
        inputPlaceholder="Paste your JSON here..."
        outputPlaceholder="Go structs will appear here..."
        convertLabel="Generate Structs"
        onConvert={jsonToGo}
      ...
      />
        ...
        <h2>How to Generate Go Structs</h2>
        <ol>
          ...
          <li><strong>Review Output</strong>: Your go structs definitions appear instantly in the output panel.</li>
