...
import { jsonToDart } from '@/lib/converters'
...
export default function ToolPageClient() {
  return (
    <>
      <ToolLayout
        title="JSON to Dart Model Generator"
        description="Generate Dart model classes from your JSON data instantly."
        inputPlaceholder="Paste your JSON here..."
        outputPlaceholder="Dart Model Classes output will appear here..."
        convertLabel="Generate Dart"
        onConvert={jsonToDart}
      ...
      />
        ...
        <h2>How to Generate Dart Model Classes</h2>
        <ol>
          ...
          <li><strong>Review Output</strong>: Your dart model classes definitions appear instantly in the output panel.</li>
