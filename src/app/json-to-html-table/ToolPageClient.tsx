...
const example = '[{"name":"JSONKits","category":"Converter","stars":1500},{"name":"ToolBox","category":"Utility","stars":850}]'
  ...
  return (
    <>
      <ToolLayout
        ...
        description="Convert JSON data to an HTML table instantly."
        inputPlaceholder="Paste your JSON here..."
        outputPlaceholder="HTML table output will appear here..."
        convertLabel="Convert to HTML"
        onConvert={jsonToHtmlTable}
        exampleInput={example}
        inputLanguage="json"
        outputLanguage="html"
        bidirectional
        onReverse={htmlTableToJson}
      />
        ...
        <h2>How to Convert JSON to HTML Tables Online</h2>
        <ol>
          ...
          <li><strong>Click Convert</strong>: Press the "JSON to HTML Tables" button. The tool validates and transforms your data instantly.</li>
        ...
        <h3>Is this JSON to HTML Tables converter safe?</h3>
        ...
        <p>Converting JSON to HTML Tables is common in modern development workflows. Here are typical scenarios:</p>
