...
export const metadata: Metadata = {
  title: 'JSON to DynamoDB Converter - Free Online Converter',
  ...
  alternates: { canonical: 'https://www.jsonkits.net/json-to-dynamodb/' },
  openGraph: {
    title: 'JSON to DynamoDB Converter - Free Online Converter',
    description: 'Convert JSON data to Amazon DynamoDB JSON format with typed attribute values. 100% free, client-side JSON tool with no server uploads.',
    url: 'https://www.jsonkits.net/json-to-dynamodb/',
    type: 'website',
  },
  twitter: {
