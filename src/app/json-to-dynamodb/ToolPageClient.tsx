...
import { jsonToDynamoDB } from '@/lib/converters'

const example = JSON.stringify({ name: 'JSONKits', version: 1, features: ['json-to-dynamodb', 'validator', 'converter'], active: true, metadata: { author: 'Dev', created: '2024-01-01' } }, null, 2)

export default function ToolPageClient() {
  return (
    <>
      <ToolLayout
        title="JSON to DynamoDB"
        description="Convert JSON data to Amazon DynamoDB JSON format with typed attribute values for database operations."
        inputPlaceholder="Paste your JSON here..."
        outputPlaceholder="Output will appear here..."
        convertLabel="JSON to DynamoDB"
        onConvert={jsonToDynamoDB}
