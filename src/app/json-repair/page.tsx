...
export const metadata: Metadata = {
  title: 'JSON Repair Online — Free JSON Tool | JSONKits',
  description: 'Attempt to repair invalid JSON by fixing quotes, trailing commas, and comments. 100% client-side and free to use.',
