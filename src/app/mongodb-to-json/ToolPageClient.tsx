...
import { mongodbToJson, jsonToMongodb } from '@/lib/converters'
...
export default function ToolPageClient() {
  return (
    <>
      <ToolLayout
        title="MongoDB to JSON Converter"
        description="Convert MongoDB document format back to standard JSON instantly."
        inputPlaceholder="Paste your input here..."
        outputPlaceholder="Converted output will appear here..."
        convertLabel="Convert to JSON"
        onConvert={mongodbToJson}
        exampleInput={example}
        inputLanguage="mongodb"
        outputLanguage="json"
        bidirectional
      ...
      <article className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 prose prose-slate dark:prose-invert">
        ...
        <h2>How to Convert MongoDB Documents to JSON Online</h2>
        <ol>
          <li><strong>Paste Input</strong>: Copy your mongodb documents data and paste it into the input editor.</li>
        ...
        <p>Yes. The tool accurately parses mongodb documents input and converts it to valid JSON while preserving all data.</p>
        ...
        <h2>Related Tools</h2>
        <ul>
          <li><a href="/mongodb--to-json">Reverse Converter</a> — Convert mongodb documents back to JSON</li>
