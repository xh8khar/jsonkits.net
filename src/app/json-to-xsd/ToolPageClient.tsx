...
import { jsonToXsd } from '@/lib/converters'

const example = JSON.stringify({ name: 'JSONKits', version: 1, features: ['json-to-xsd', 'validator', 'converter'], active: true, metadata: { author: 'Dev', created: '2024-01-01' } }, null, 2)
...
export default function ToolPageClient() {
  return (
    <>
      <ToolLayout
        title="JSON to XSD"
        description="Generate XML Schema Definition (XSD) from JSON data samples for enterprise XML data validation."
        inputPlaceholder="Paste your JSON here..."
        outputPlaceholder="Output will appear here..."
        convertLabel="JSON to XSD"
        onConvert={jsonToXsd}
