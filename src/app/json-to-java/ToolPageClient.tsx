...
import { jsonToJava } from '@/lib/converters'
  ...
  return (
    <>
      <ToolLayout
        ...
        description="Generate Java POJO classes with getters and setters from your JSON data instantly. Perfect for deserializing API responses in Java projects."
        inputPlaceholder="Paste your JSON here..."
        outputPlaceholder="Java classes will appear here..."
        convertLabel="Generate Classes"
        onConvert={jsonToJava}
      ...
      />
        ...
        <h2>Why Generate Java POJOs from JSON?</h2>
        <p>Manually writing java pojos for every API response is tedious and error-prone. Automatic generation ensures your types always match the actual data structure, saving time and preventing bugs. This is especially valuable when:</p>
        <ul>
        ...
        <h2>How to Generate Java POJOs</h2>
        <ol>
          ...
          <li><strong>Review Output</strong>: Your java pojos definitions appear instantly in the output panel.</li>
