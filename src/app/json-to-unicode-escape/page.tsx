...
export const metadata: Metadata = {
  title: 'JSON to Unicode Escape - Free Online Converter ',
  ...
  alternates: { canonical: 'https://www.jsonkits.net/json-to-unicode-escape/' },
  openGraph: {
    title: 'JSON to Unicode Escape - Free Online Converter ',
    description: 'Convert JSON to Unicode escape sequences. 100% free, client-side JSON tool with no server uploads.',
    url: 'https://www.jsonkits.net/json-to-unicode-escape/',
    type: 'website',
  },
  twitter: {
