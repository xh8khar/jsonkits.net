...
import { jsonToUnicodeEscape, unicodeEscapeToJson } from '@/lib/converters'
...
export default function ToolPageClient() {
  return (
    <>
      <ToolLayout
        title="JSON to Unicode Escape Converter"
        description="Convert JSON to Unicode escape sequences (\\uXXXX) instantly."
        inputPlaceholder="Paste your input here..."
        outputPlaceholder="Converted output will appear here..."
        convertLabel="Escape"
        onConvert={jsonToUnicodeEscape}
        exampleInput={example}
        inputLanguage="json"
        outputLanguage="unicode"
        bidirectional
        onReverse={unicodeEscapeToJson}
      />
      <article className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 prose prose-slate dark:prose-invert">
          ...
          <table className="min-w-full border-collapse border border-slate-300 dark:border-slate-600 my-4">
            ...
            <tbody>
              <tr>
                ...
                <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">allow representing Unicode characters in ASCII-only contexts</td>
              </tr>
              <tr>
        ...
        <h2>How to Convert JSON to Unicode Escape Online</h2>
        <ol>
          <li><strong>Paste JSON</strong>: Copy your JSON and paste it into the input editor.</li>
          <li><strong>Click Convert</strong>: Press the "Escape" button to transform your data.</li>
        ...
        <h2>Related Tools</h2>
        <ul>
          <li><a href="/unicode-escape">Reverse Converter</a> — Convert unicode escape back to JSON</li>
