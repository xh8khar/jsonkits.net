...
import { jsonClipboardViewer } from '@/lib/converters'
...
export default function ToolPageClient() {
  return (
    <>
      <ToolLayout
        title="JSON Clipboard Viewer"
        description="View and explore JSON pasted from your clipboard. Perfect for developers working with JSON data."
        inputPlaceholder="Paste your JSON here..."
        outputPlaceholder="Result will appear here..."
        convertLabel="View"
        onConvert={jsonClipboardViewer}
