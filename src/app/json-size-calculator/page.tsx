...
export const metadata: Metadata = {
  title: 'JSON Size Calculator Online — Free JSON Tool | JSONKits',
  description: 'Calculate the byte size, element count, and depth of JSON data. 100% client-side and free to use.',
