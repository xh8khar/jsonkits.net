...
import { jsonToPhpClass } from '@/lib/converters'
...
export default function ToolPageClient() {
  return (
    <>
      <ToolLayout
        title="JSON to PHP Class Generator"
        description="Generate PHP classes with getters and setters from your JSON data instantly."
        inputPlaceholder="Paste your JSON here..."
        outputPlaceholder="PHP Classes output will appear here..."
        convertLabel="Generate PHP"
        onConvert={jsonToPhpClass}
      ...
      />
        ...
        <h2>How to Generate PHP Classes</h2>
        <ol>
          ...
          <li><strong>Review Output</strong>: Your php classes definitions appear instantly in the output panel.</li>
