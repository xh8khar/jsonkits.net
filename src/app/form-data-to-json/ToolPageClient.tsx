...
import { formDataToJson, jsonToFormData } from '@/lib/converters'
...
export default function ToolPageClient() {
  return (
    <>
      <ToolLayout
        title="Form Data to JSON Converter"
        description="Parse URL-encoded form data back into JSON format instantly."
        inputPlaceholder="Paste your input here..."
        outputPlaceholder="Converted output will appear here..."
        convertLabel="Parse to JSON"
        onConvert={formDataToJson}
        exampleInput={example}
        inputLanguage="formdata"
        outputLanguage="json"
        bidirectional
      ...
      <article className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 prose prose-slate dark:prose-invert max-w-none">
        ...
        <h2>How to Convert Form Data to JSON Online</h2>
        <ol>
          <li><strong>Paste Input</strong>: Copy your form data data and paste it into the input editor.</li>
        ...
        <p>Yes. The tool accurately parses form data input and converts it to valid JSON while preserving all data.</p>
        ...
        <h2>Related Tools</h2>
        <ul>
          <li><a href="/form-data--to-json">Reverse Converter</a> — Convert form data back to JSON</li>
