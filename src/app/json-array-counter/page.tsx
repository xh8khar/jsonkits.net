...
export const metadata: Metadata = {
  title: 'JSON Array Counter Online — Free JSON Tool | JSONKits',
  description: 'Count all arrays in JSON and report their sizes and nesting. 100% client-side and free to use.',
