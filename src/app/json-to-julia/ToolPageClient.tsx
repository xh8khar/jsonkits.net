...
import { jsonToJulia } from '@/lib/converters'

const example = JSON.stringify({ name: 'JSONKits', version: 1, features: ['json-to-julia', 'validator', 'converter'], active: true, metadata: { author: 'Dev', created: '2024-01-01' } }, null, 2)
...
export default function ToolPageClient() {
  return (
    <>
      <ToolLayout
        title="JSON to Julia"
        description="Generate Julia struct definitions with JSON parsing support from JSON data samples."
        inputPlaceholder="Paste your JSON here..."
        outputPlaceholder="Output will appear here..."
        convertLabel="JSON to Julia"
        onConvert={jsonToJulia}
