...
import { jsonToXml, xmlToJson } from '@/lib/converters'

const example = JSON.stringify({ name: 'JSONKits', tools: ['formatter', 'validator', 'converter'], active: true }, null, 2)
  ...
  return (
    <>
      <ToolLayout
        ...
        description="Convert JSON data to XML format instantly. Perfect for SOAP APIs, RSS feeds, and legacy systems that require XML."
        inputPlaceholder="Paste your JSON here..."
        outputPlaceholder="XML output will appear here..."
        convertLabel="Convert to XML"
        onConvert={jsonToXml}
      ...
      />
        ...
        <ol>
          ...
          <li><strong>Click Convert</strong>: Press the "JSON to XML" button. The tool validates and transforms your data instantly.</li>
        ...
        <h3>Is this JSON to XML converter safe?</h3>
        ...
        <p>Converting JSON to XML is common in modern development workflows. Here are typical scenarios:</p>
