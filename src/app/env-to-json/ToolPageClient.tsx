...
import { envToJson, jsonToEnv } from '@/lib/converters'

const example = `APP_NAME=JSONKits\nAPP_VERSION=1\nDEBUG=true`
  ...
  return (
    <>
      <ToolLayout
        ...
        description="Parse .env environment variable files back into JSON format instantly."
      ...
      <article className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 prose prose-slate dark:prose-invert">
        ...
        <h2>How to Convert .env to JSON Online</h2>
        <ol>
          <li><strong>Paste Input</strong>: Copy your .env data and paste it into the input editor.</li>
        ...
        <p>Yes. The tool accurately parses .env input and converts it to valid JSON while preserving all data.</p>
        ...
        <h2>Related Tools</h2>
        <ul>
          <li><a href="/env--to-json">Reverse Converter</a> — Convert .env back to JSON</li>
