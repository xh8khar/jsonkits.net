...
export const metadata: Metadata = {
  title: 'JSON Rename Keys Online — Free JSON Tool | JSONKits',
  description: 'Rename JSON object keys using a key mapping definition. 100% client-side and free to use.',
