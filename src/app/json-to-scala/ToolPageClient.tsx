...
import { jsonToScala } from '@/lib/converters'
...
export default function ToolPageClient() {
  return (
    <>
      <ToolLayout
        title="JSON to Scala Case Class Generator"
        description="Generate Scala case classes with Play JSON from your JSON data instantly."
        inputPlaceholder="Paste your JSON here..."
        outputPlaceholder="Scala Case Classes output will appear here..."
        convertLabel="Generate Scala"
        onConvert={jsonToScala}
      ...
      />
        ...
        <h2>How to Generate Scala Case Classes</h2>
        <ol>
          ...
          <li><strong>Review Output</strong>: Your scala case classes definitions appear instantly in the output panel.</li>
