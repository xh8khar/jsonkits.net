...
import { jsonToTerraform, terraformToJson } from '@/lib/converters'

const example = `{"region":"us-east-1","instanceType":"t2.micro","count":3}`

export default function ToolPageClient() {
  return (
    <>
      <ToolLayout
        title="JSON to Terraform Variables Converter"
        description="Convert JSON data to Terraform variables (TFvars) format instantly."
        inputPlaceholder="Paste your input here..."
        outputPlaceholder="Converted output will appear here..."
        convertLabel="Convert to Terraform"
        onConvert={jsonToTerraform}
        exampleInput={example}
        inputLanguage="json"
        outputLanguage="yaml"
        bidirectional
        onReverse={terraformToJson}
      />
      <article className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 prose prose-slate dark:prose-invert max-w-none">
        ...
        <ol>
          ...
          <li><strong>Click Convert</strong>: Press the "Convert to Terraform" button to transform your data.</li>
        ...
        <h2>Related Tools</h2>
        <ul>
          <li><a href="/terraform">Reverse Converter</a> — Convert yaml back to JSON</li>
