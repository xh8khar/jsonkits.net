...
import { javaClassToJson } from '@/lib/converters'

const example = `public class User {
  private String name;
  private int age;
...
export default function ToolPageClient() {
  return (
    <>
      <ToolLayout
        title="Java Class to JSON Generator"
        description="Generate sample JSON data from Java class definitions instantly."
        inputPlaceholder="Paste your source code here..."
        outputPlaceholder="JSON output will appear here..."
        convertLabel="Convert to JSON"
        onConvert={javaClassToJson}
      ...
      />
        ...
        <h2>Java POJOs vs JSON: Understanding the Difference</h2>
        <p>Java POJOs define the structure and types of data in code, while JSON provides a language-agnostic serialization format. Converting one to the other is essential for data interchange between services written in different languages.</p>
        ...
        <h2>How to Convert Java POJOs to JSON Online</h2>
        <ol>
          <li><strong>Paste your code</strong>: Copy your java pojos definition from your editor.</li>
        ...
        <p>Converting java pojos to JSON is useful for generating API documentation from code, creating test fixtures from type definitions, producing sample data for frontend development, or debugging serialization issues by examining expected JSON shapes.</p>
        <h2>Related Tools</h2>
        <ul>
          <li><a href="/json-to-java">JSON to Java POJOs</a> — Reverse direction: generate java pojos from JSON</li>
