...
import { jsonToCsharp } from '@/lib/converters'
  ...
  return (
    <>
      <ToolLayout
        ...
        description="Generate C# classes with JSON attributes from your JSON data instantly."
        inputPlaceholder="Paste your JSON here..."
        outputPlaceholder="C# Classes output will appear here..."
        convertLabel="Generate C#"
        onConvert={jsonToCsharp}
      ...
      />
        ...
        <h2>How to Generate C# Classes</h2>
        <ol>
          ...
          <li><strong>Review Output</strong>: Your c# classes definitions appear instantly in the output panel.</li>
