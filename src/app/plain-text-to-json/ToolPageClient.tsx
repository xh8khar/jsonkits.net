...
import { jsonToPlainText, plainTextToJson } from '@/lib/converters'

const example = 'user.name = Alice\nuser.age = 30\nuser.active = true\nroles[0] = admin\nroles[1] = editor'

export default function ToolPageClient() {
  return (
    <>
      <ToolLayout
        title="Plain Text to JSON Converter"
        description="Convert key: value text back into JSON format instantly."
        inputPlaceholder="Paste your plain text here..."
        outputPlaceholder="JSON output will appear here..."
        convertLabel="Convert to JSON"
        onConvert={plainTextToJson}
        exampleInput={example}
        inputLanguage="text"
        outputLanguage="json"
        bidirectional
        onReverse={jsonToPlainText}
      />
          ...
          <table className="min-w-full border-collapse border border-slate-300 dark:border-slate-600 my-4">
            <thead>
              <tr className="bg-slate-100 dark:bg-slate-800">
                ...
                <th className="border border-slate-300 dark:border-slate-600 px-4 py-2 text-left font-semibold">Plain Text</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                ...
                <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">Excellent. Simple key: value lines.</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">Logging and simple data dumps.</td>
              </tr>
            </tbody>
          </table>
        </div>
        <h2>How to Convert Plain Text to Plain Text Online</h2>
        <ol>
          <li><strong>Paste your Plain Text</strong>: Copy your Plain Text code from your editor or API response and paste it into the input box.</li>
        ...
        <p>Converting Plain Text to Plain Text is common in modern development workflows. Here are typical scenarios:</p>
        ...
        <h2>Related Tools</h2>
        <ul>
          <li><a href="/plain-text-to-json">Plain Text to JSON</a> — Reverse conversion from Plain Text back to JSON</li>
