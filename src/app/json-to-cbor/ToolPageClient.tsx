...
import { jsonToCbor } from '@/lib/converters'

const example = JSON.stringify({ name: 'JSONKits', version: 1, features: ['json-to-cbor', 'validator', 'converter'], active: true, metadata: { author: 'Dev', created: '2024-01-01' } }, null, 2)
...
export default function ToolPageClient() {
  return (
    <>
      <ToolLayout
        title="JSON to CBOR"
        description="Convert JSON data to CBOR (Concise Binary Object Representation) format for compact binary encoding."
        inputPlaceholder="Paste your JSON here..."
        outputPlaceholder="Output will appear here..."
        convertLabel="JSON to CBOR"
        onConvert={jsonToCbor}
