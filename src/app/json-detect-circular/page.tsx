...
export const metadata: Metadata = {
  title: 'JSON Detect Circular Online — Free JSON Tool | JSONKits',
  description: 'Detect circular references in JSON data structures. 100% client-side and free to use.',
