...
export const metadata: Metadata = {
  title: 'JSON Minifier Online — Free JSON Tool | JSONKits',
  description: 'Compress JSON by removing whitespace to reduce file size. 100% client-side and free to use.',
