...
import { jsonToPrometheus } from '@/lib/converters'

const example = JSON.stringify({ name: 'JSONKits', version: 1, features: ['json-to-prometheus', 'validator', 'converter'], active: true }, null, 2)

export default function ToolPageClient() {
  return (
    <>
      <ToolLayout
        title="JSON to Prometheus"
        description="Convert JSON data to Prometheus metric format with gauge metrics for monitoring systems."
        inputPlaceholder="Paste your JSON here..."
        outputPlaceholder="JSON to Prometheus output will appear here..."
        convertLabel="Convert"
        onConvert={jsonToPrometheus}
      ...
      <article className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 prose prose-slate dark:prose-invert">
        ...
        <p>JSON to Prometheus is a free online tool that converts JSON data into prometheus format for use in various programming environments. This tool is 100% client-side and processes all data locally in your browser.</p>
        <h2>How to Use</h2>
        <ol>
