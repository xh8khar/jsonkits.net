...
export const metadata: Metadata = {
  title: 'JSON Collection Counter Online — Free JSON Tool | JSONKits',
  description: 'Count field presence, types, and nulls across array items. 100% client-side and free to use.',
