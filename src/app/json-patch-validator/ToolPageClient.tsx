...
export default function ToolPageClient() {
  return (
    <>
      <ToolLayout
        title="JSON Patch Validator"
        description="Validate RFC 6902 JSON Patch operation lists. Perfect for developers working with JSON data."
        inputPlaceholder="Paste your JSON here..."
        outputPlaceholder="Result will appear here..."
        convertLabel="Validate"
        onConvert={jsonPatchValidator}
        exampleInput={example}
        outputLanguage={"json"}
      />
      <article className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 prose prose-slate dark:prose-invert max-w-none">
        <h2>What Is This Tool?</h2>
        <p>Validate RFC 6902 JSON Patch operation lists. This tool processes your JSON data entirely in your browser — nothing is uploaded to any server.</p>
        <h2>How to Use</h2>
        <ol>
          <li><strong>Paste your JSON</strong>: Enter or paste JSON data into the input editor.</li>
          <li><strong>Click Validate</strong>: Press the convert button to process your input.</li>
