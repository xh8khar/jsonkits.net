...
import { jsonToJsObject, jsObjectToJson } from '@/lib/converters'
  ...
  return (
    <>
      <ToolLayout
        ...
        description="Convert JSON data to JavaScript object literal syntax instantly."
        inputPlaceholder="Paste your input here..."
        outputPlaceholder="Converted output will appear here..."
        convertLabel="Convert to JS"
        onConvert={jsonToJsObject}
        exampleInput={example}
        inputLanguage="json"
        outputLanguage="javascript"
        bidirectional
        onReverse={jsObjectToJson}
      />
      <article className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 prose prose-slate dark:prose-invert">
          ...
          <table className="min-w-full border-collapse border border-slate-300 dark:border-slate-600 my-4">
            ...
            <tbody>
              <tr>
                ...
                <td className="border border-slate-300 dark:border-slate-600 px-4 py-2">are the native syntax for defining objects in JavaScript code</td>
              </tr>
              <tr>
        ...
        <h2>How to Convert JSON to JavaScript Objects Online</h2>
        <ol>
          <li><strong>Paste JSON</strong>: Copy your JSON and paste it into the input editor.</li>
          <li><strong>Click Convert</strong>: Press the "Convert to JS" button to transform your data.</li>
        ...
        <h2>Related Tools</h2>
        <ul>
          <li><a href="/js-object">Reverse Converter</a> — Convert javascript objects back to JSON</li>
