  ...
  return (
    ...
    >
      <div className="flex items-start gap-4">
        <div className="p-2.5 rounded-lg bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 group-hover:text-blue-500 dark:group-hover:text-blue-400 transition-colors">
          {iconMap[tool.icon] || iconMap.Braces}
        </div>
